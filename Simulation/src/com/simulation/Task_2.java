...
public class Task_2 {
    ...
    public static int next_event_type, num_progs_delayed_1, num_progs_delayed_2, num_progs_delayed, num_delays_required, num_events, num_in_q_1, num_in_q_2, server_status_1, server_status_2;
    public static double seed1, seed2, seed3, seed4, yy1, yy2, yy3, yy4, yy;
    ...
    public static void initialize(){
        ...
        num_progs_delayed = 0;
        num_progs_delayed_1 = 0;
        num_progs_delayed_2 = 0;
        ...
        yy1=yy;
        time_next_event[2] = time + expon(mean_interarrival, yy2);
        yy2 = yy1;
        time_next_event[3] = time + expon(mean_interarrival, yy3);
        yy3 = yy2;
        time_next_event[4] = time + expon(mean_interarrival, yy4);
    }
    ...
    public static void arrive_2(){
        /* Schedule next arrival. */
        time_next_event[3] = time + expon(mean_service_1, yy3);
        yy3=yy;
    ...
    public static void depart_2(){
        ...
        departure. */
            ++num_progs_delayed;
            ++num_progs_delayed_2;
            time_next_event[4] = time + expon(mean_service_2, yy4);
            yy4=yy;
